...
function SignUpAPI(props) {
    ...
    useEffect(() => {
        if (props.APIDetailsSignUp.user.length > 0) {
            ...
            const url = 'https://projeto.codesdevs.com/AAreg.php'
            fetch(url, {
                method: 'POST',
                body: formData
            })
                ...
                .then((data) => {
                    if (data['success']===true){
                        ...
                        setUrlToLogin(`https://projeto.codesdevs.com/?rest_route=/simple-jwt-login/v1/autologin&jwt=${data['data']['jwt']}`)
                        console.log(data)
            ...
            fetch(urlToLogin, {
                ...
                .then((response) => {
                    if (response.status == '200') {
                        ...
                        window.location.replace('https://projeto.codesdevs.com/#/')
                    }
                    else {
                        console.log('error')
                    }
